                                ...
                                <div class="product_checkout">
                                    @foreach($order->items as $item)
                                        <div class="one_product_block_cart">
                                            ...
                                            <div
                                                class="comment_adds_product_to_cart @if($item->comment !== null) has_comment @endif">
...
-->
                                    ...
                                    <div class="issue_time">
                                        ...
                                        <div class="line_wrap_checkbox time_check">
                                            <label class="line_one_checkbox">
                                                <input type="radio" name="time_issue"
                                                       value="1" {{old('time_issue', 1)==1 ? 'checked' : '' }}>
                                                <span></span>
                                                <p>{{trans('main.time_now')}}</p>
                                            </label>
                                            <label class="line_one_checkbox">
                                                <input type="radio" name="time_issue" value="2"
                                                       {{old('time_issue')==2 ? 'checked' : '' }} class="time_step">
                                                <span></span>
                                        ...
                                        <div class="show_time">
                                            <input readonly type="text" name="time" value="{{old('time')}}" id="example"
