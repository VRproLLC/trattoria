                ...
                <div class="show_tab_click ">
                    <div class="one_tab_show active this_not_border">
                        <div class="append_addres_block">
                            ...
                            <a class="search_parent_block new_parent_search" href="{{route('main.set_pickup_place', ['id' => $organization->id])}}" data-current_organization="{{\Illuminate\Support\Facades\Cookie::get('organization_id')}}" data-organization="{{$organization->id}}" data-latitude="{{$organization->latitude}}" data-longitude="{{$organization->longitude}}" data-address="{{$organization->address}}" data-worktime="{{$organization->workTime}}">
                                <div class="image_zvd">
                                ...
                                <div class="title_description">
                                    <p class="title_name_org">Траттория Ломбардия</p>
                                    <p>Самовывоз, доставка по всему городу нашими партнерами{{ $organization->description }}</p>
                                </div>
                                ...
                                <div class="line_new_info">
                                    ...
                                    <p class="wrap_wrk_infos"><img src="{{asset('image/dish.svg')}}" alt="">від 50 ₴ </p>
                                    <p class="wrap_wrk_infos"><img src="{{asset('image/localization.svg')}}" alt="">2.2 км</p>
                                </div>
                            </a>
                            @else
                            <div class="search_parent_block new_parent_search">
                                ...
                                <div class="title_description">
                                    <p class="title_name_org">Траттория Ломбардия</p>
                                    <p class="new_info_point">Самовывоз, доставка по всему городу нашими партнерами{{ $organization->description }}</p>
                                </div>
                                <p class="home_addr_line"><img src="{{asset('image/localization.svg')}}" alt="">{{$organization->address}}</p>
                                <div class="line_new_info">
                                    <p class="wrap_wrk_infos"><img src="{{asset('image/time_work.svg')}}" alt="">25-35 хв</p>
